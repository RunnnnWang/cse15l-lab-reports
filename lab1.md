...
* cd changes the directory according to the argument, but if there is no argument, it changes the directory to the home directory. Thus, my working directory changes to my home directory in this workspace and there is no output. 
* No error. 
...
* Working directory: this workspace's home directory
* cat concatenates one or multiple files and prints out their contents. In this command, because I don't put any argument after cat, it is waiting for me to put a directory and I stopped it with command+C. Since there is no file to print, there is no output. 
* No error.
...
* Working directory: this workspace's home directory
* I changed the directory to lecture1 and now in the next line, you can see from the left I am in the lecture1 directory.
* No error.
...
* Working directory: lecture1
* ls prints the files in the directory. I print the files list in this lecture1 directory and there are en-us.txt, es-mx.txt, ko-ko.txt, zh-cn.txt in the file. Thus, those files are printed in the terminal with a space to separate them.
* No error. 
